...
export class WebSocketService {
  ...
  connect(): void {
    ...
    try {
      ...
      this.socket.onopen = () => {
        console.log('🔗 WebSocket conectado (Users App)');
      ...
      this.socket.onmessage = (event) => {
        try {
          ...
          console.log('📨 Mensaje WebSocket recibido (Users):', message);
      ...
      this.socket.onclose = (event) => {
        console.log('🔌 WebSocket desconectado (Users):', event.code, event.reason);
        this.connectionSubject.next(false);
        this.attemptReconnect();
      };

      this.socket.onerror = (error) => {
        console.error('❌ Error WebSocket (Users):', error);
        this.connectionSubject.next(false);
      };

    } catch (error) {
      console.error('❌ Error al conectar WebSocket (Users):', error);
      this.attemptReconnect();
    }
  }
  ...
  // Métodos específicos para la aplicación de usuarios
